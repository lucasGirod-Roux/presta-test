...
return [
        ...
        0 => '{^(?'
                ...
                .'|/sell/(?'
                    .'|c(?'
                        .'|atalog/(?'
                            .'|products(?'
                                ...
                                .'|\\-v2/(?'
                                    ...
                                    .'|(\\d+)/preview(*:3484)'
                                    .'|(\\d+)/edit(*:3503)'
                                    .'|virtual\\-product\\-file/(\\d+)(*:3540)'
                                    .'|(\\d+)/delete(*:3561)'
                                    .'|(\\d+)/duplicate(*:3585)'
                                    .'|(\\d+)/toggle_status(*:3613)'
                                    .'|search/(?'
                                        .'|([a-zA-Z]{2}(?:-[a-zA-Z]{2})?)(*:3662)'
                                        .'|combination/([a-zA-Z]{2}(?:-[a-zA-Z]{2})?)(*:3713)'
                                    .')'
                                .')'
                            .')'
                            .'|ca(?'
                                .'|t(?'
                                    .'|egories(?'
                                        ...
                                        .'|/(?'
                                            ...
                                            .'|(\\d+)/edit(*:3810)'
                                            .'|(\\d+)/edit\\-root(*:3835)'
                                            .'|(\\d+)/delete\\-cover\\-image(*:3870)'
                                            .'|(\\d+)/menu\\-thumbnails/(0|1|2)/delete(*:3916)'
                                        .')'
                                    .')'
                                    .'|alog\\-price\\-rules/(?'
                                        .'|(\\d+)/edit(*:3959)'
                            ...
                            .'|suppliers/(?'
                                ...
                                .'|(\\d+)/edit(*:4102)'
                                .'|(\\d+)/delete(*:4123)'
                                .'|(\\d+)/toggle\\-status(*:4152)'
                            .')'
                            .'|brands/(?'
                                .'|(\\d+)/view(*:4182)'
                                .'|(\\d+)/edit(*:4201)'
                                .'|(\\d+)/delete(*:4222)'
                                .'|(\\d+)/toggle\\-status(*:4251)'
                                .'|addresses/(?'
                                    .'|(\\d+)/edit(*:4283)'
                                    .'|(\\d+)/delete(*:4304)'
                                .')'
                            ...
                            .'|attribute\\-groups/(?'
                                .'|(\\d+)/attributes(?'
                                    .'|(*:4355)'
                                .')'
                                .'|(\\d+)/attributes/new(*:4385)'
                                .'|(\\d+)/attributes/(\\d+)/edit(*:4421)'
                                .'|(\\d+)/attributes/([^/]++)/delete(*:4462)'
                                .'|(\\d+)/attributes/delete(*:4494)'
                                .'|(\\d+)/attributes/update\\-position(*:4536)'
                                .'|(\\d+)/view(*:4555)'
                                .'|(\\d+)/edit(*:4574)'
                                .'|(\\d+)/delete(*:4595)'
                            .')'
                        ...
                        .'|ustomer(?'
                            .'|s/(?'
                                .'|(\\d+)/edit(*:4631)'
                                .'|(\\d+)/view(*:4650)'
                                .'|(\\d+)/set\\-private\\-note(*:4683)'
                                .'|(\\d+)/toggle\\-status(*:4712)'
                                .'|([^/]++)/transform\\-guest\\-to\\-customer(*:4760)'
                                .'|(\\d+)/toggle\\-newsletter\\-subscription(*:4807)'
                                .'|(\\d+)/toggle\\-partner\\-offer\\-subscription(*:4858)'
                                .'|(\\d+)/carts(*:4878)'
                                .'|(\\d+)/orders(*:4899)'
                            .')'
                            .'|\\-service/(?'
                    ...
                    .'|a(?'
                        .'|ddresses/(?'
                            .'|(\\d+)/edit(*:5132)'
                            .'|order/(\\d+)/(delivery|invoice)/edit(*:5176)'
                            .'|cart/(\\d+)/(delivery|invoice)/edit(*:5219)'
                            .'|(\\d+)/delete(*:5240)'
                        .')'
                        .'|ttachments/(?'
                            .'|(\\d+)/edit(*:5274)'
                    ...
                    .'|orders/(?'
                        ...
                        .'|carts/(?'
                            ...
                            .'|(\\d+)/currency(*:5517)'
                            .'|(\\d+)/language(*:5540)'
                            .'|(\\d+)/rules/delivery\\-settings(*:5579)'
                            .'|([^/]++)/cart\\-rules(?'
                                .'|(*:5611)'
                                .'|/([^/]++)/delete(*:5636)'
                            .')'
                            .'|(\\d+)/products(*:5660)'
                            .'|(\\d+)/products/(\\d+)/price(*:5695)'
                            .'|(\\d+)/products/(\\d+)/quantity(*:5733)'
                            .'|(\\d+)/delete\\-product(*:5763)'
                        .')'
                        .'|(\\d+)/generate\\-invoice\\-pdf(*:5801)'
                        .'|(\\d+)/generate\\-delivery\\-slip\\-pdf(*:5845)'
                        .'|(\\d+)/view(*:5864)'
                        .'|(\\d+)/cart\\-rules(*:5890)'
                        .'|list/(\\d+)/status(*:5916)'
                        .'|(\\d+)/status(*:5937)'
                        .'|(\\d+)/payment(*:5959)'
                        .'|(\\d+)/duplicate\\-cart(*:5989)'
                        .'|(\\d+)/currency/change(*:6019)'
                        .'|(\\d+)/products/(\\d+)(*:6048)'
                        .'|(\\d+)/cart\\-rules/(\\d+)/delete(*:6087)'
                        .'|(\\d+)/history/(\\d+)/statuses/(\\d+)/resend\\-email(*:6144)'
                        .'|(\\d+)/preview(*:6166)'
                        .'|(\\d+)/shipping(*:6189)'
                        .'|(\\d+)/invoice/(\\d+)/note(*:6222)'
                        .'|(\\d+)/invoice(*:6244)'
                        .'|([^/]++)/send\\-message(*:6275)'
                        .'|(\\d+)/partial\\-refund(*:6305)'
                        .'|(\\d+)/standard\\-refund(*:6336)'
                        .'|(\\d+)/return\\-product(*:6366)'
                        .'|(\\d+)/products(*:6389)'
                        .'|(\\d+)/products/(\\d+)/delete(*:6425)'
                        .'|(\\d+)/discounts(*:6449)'
                        .'|(\\d+)/prices(*:6470)'
                        .'|(\\d+)/payments(*:6493)'
                        .'|(\\d+)/products(*:6516)'
                        ...
                        .'|(\\d+)/shipping(*:6586)'
                        .'|(\\d+)/cancellation(*:6613)'
                        .'|display\\-customization\\-image/(\\d+)/(.+)(*:6662)'
                        .'|(\\d+)/products/prices(*:6692)'
                        .'|(\\d+)/set\\-internal\\-note(*:6726)'
                        .'|credit\\-slips/(\\d+)/pdf(*:6758)'
                    .')'
                .')'
                .'|/improve/(?'
                    .'|international/(?'
                        .'|languages/(?'
                            ...
                            .'|(\\d+)/delete(*:6842)'
                            .'|([^/]++)/toggle\\-status(*:6874)'
                            .'|bulk\\-toggle\\-status/(enable|disable)(*:6920)'
                        .')'
                        .'|c(?'
                            .'|urrencies/(?'
                                .'|(\\d+)/edit(*:6957)'
                                ...
                                .'|reference\\-data/([^/]++)(*:7040)'
                                .'|bulk\\-toggle\\-status/(enable|disable)(*:7086)'
                            .')'
                            .'|ountries/(\\d+)/edit(*:7115)'
                        .')'
                        .'|tax(?'
                            .'|es/(?'
                                .'|(\\d+)/edit(*:7147)'
                                .'|(\\d+)/delete(*:7168)'
                                .'|(\\d+)/toggle\\-status(*:7197)'
                            .')'
                            .'|_rules_groups/(?'
                                .'|(\\d+)/edit(*:7234)'
                                .'|(\\d+)/delete(*:7255)'
                                .'|(\\d+)/toggle\\-status(*:7284)'
                            .')'
                        .')'
                        .'|states/(?'
                            .'|(\\d+)/edit(*:7315)'
                        ...
                        .'|zones/(?'
                            .'|(\\d+)/edit(*:7397)'
                            .'|(\\d+)/delete(*:7418)'
                            .'|(\\d+)/toggle\\-status(*:7447)'
                            .'|bulk\\-toggle\\-status/(enable|disable)(*:7493)'
                        .')'
                    .')'
                    .'|modules/manage(?'
                        .'|(?:/([^/]++)(?:/([^/]++))?)?(*:7549)'
                        .'|/(?'
                            .'|action/(?'
                                .'|(install|uninstall|enable|disable|enableMobile|disableMobile|reset|upgrade)/([^/]++)(*:7656)'
                                .'|configure/([^/]++)(*:7683)'
                            .')'
                            .'|bulk/(install|uninstall|configure|enable|disable|reset|upgrade)(*:7756)'
                            .'|update/all(*:7775)'
                        .')'
                    .')'
                    .'|design/(?'
                        .'|themes/(?'
                            .'|([a-zA-Z0-9_.-]+)/enable(*:7830)'
                            .'|([a-zA-Z0-9_.-]+)/delete(*:7863)'
                            .'|([a-zA-Z0-9_.-]+)/reset\\-layouts(*:7904)'
                        .')'
                        .'|cms\\-pages/(?'
                            .'|(\\d+)/edit(*:7938)'
                            .'|(\\d+)/toggle\\-status(*:7967)'
                            .'|(\\d+)/delete(*:7988)'
                            .'|category/(?'
                                .'|(\\d+)/edit(*:8019)'
                                .'|(\\d+)/delete(*:8040)'
                                .'|(\\d+)/toggle\\-status(*:8069)'
                            .')'
                        .')'
                        .'|mail_theme/(?'
                            .'|send(?'
                    ...
                    .'|shipping/carriers/(?'
                        .'|(\\d+)/edit(*:8474)'
                        .'|(\\d+)/delete(*:8495)'
                        .'|(\\d+)/toggle\\-status(*:8524)'
                        .'|(\\d+)/toggle\\-is\\-free(*:8555)'
                    .')'
                .')'
                .'|/api/(?'
                    .'|stock(?'
                        .'|s/(?'
                            ...
                            .'|product/(?'
                                .'|(\\d+)(*:8617)'
                                .'|(\\d+)/combination/(\\d+)(*:8649)'
                            .')'
                        .')'
                        .'|\\-movements/product/(\\d+)(*:8685)'
                    .')'
                    .'|i18n/(\\w+)(*:8705)'
                    .'|translations/(?'
                        .'|tree/([^/]++)/([^/]++)(?:/([^/]++))?(*:8766)'
    ...
    [ // $dynamicRoutes
        ...
        3540 => [[['_route' => 'admin_products_v2_download_virtual_product_file', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::downloadVirtualFileAction', '_legacy_controller' => 'AdminProducts'], ['virtualProductFileId'], ['GET' => 0], null, false, true, null]],
        3561 => [[['_route' => 'admin_products_v2_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::deleteAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:delete'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        3585 => [[['_route' => 'admin_products_v2_duplicate', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::duplicateAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:duplicate'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0], null, false, false, null]],
        3613 => [[['_route' => 'admin_products_v2_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::toggleStatusAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:statusproduct'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0], null, false, false, null]],
        3662 => [[['_route' => 'admin_products_v2_search_associations', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::searchAssociationsAction', '_legacy_controller' => 'AdminProducts'], ['languageCode'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3713 => [[['_route' => 'admin_products_v2_search_combinations', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\CombinationController::searchCombinationProductsAction', '_legacy_controller' => 'AdminProducts'], ['languageCode'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3755 => [[['_route' => 'admin_categories_index', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::indexAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories', '_legacy_parameters' => ['id_category' => 'categoryId'], 'categoryId' => null], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3791 => [[['_route' => 'admin_categories_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::toggleStatusAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:statuscategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['POST' => 0], null, false, false, null]],
        3810 => [[['_route' => 'admin_categories_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::editAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:updatecategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3835 => [[['_route' => 'admin_categories_edit_root', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::editRootAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:updatecategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3870 => [[['_route' => 'admin_categories_delete_cover_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::deleteCoverImageAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:deleteImage', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['POST' => 0], null, false, false, null]],
        3916 => [[['_route' => 'admin_categories_delete_menu_thumbnail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::deleteMenuThumbnailAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:forceDeleteThumb', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId', 'menuThumbnailId'], ['POST' => 0], null, false, false, null]],
        3959 => [[['_route' => 'admin_catalog_price_rules_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CatalogPriceRuleController::editAction', '_legacy_controller' => 'AdminSpecificPriceRule', '_legacy_parameters' => ['id_specific_price_rule' => 'catalogPriceRuleId']], ['catalogPriceRuleId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3980 => [[['_route' => 'admin_catalog_price_rules_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CatalogPriceRuleController::deleteAction', '_legacy_controller' => 'AdminSpecificPriceRule', '_legacy_parameters' => ['id_specific_price_rule' => 'catalogPriceRuleId']], ['catalogPriceRuleId'], ['POST' => 0], null, false, false, null]],
        4024 => [[['_route' => 'admin_cart_rule_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CartRuleController::toggleStatusAction', '_legacy_controller' => 'AdminCartRules', '_legacy_parameters' => ['id_cart_rule' => 'cartRuleId']], ['cartRuleId'], ['POST' => 0], null, false, false, null]],
        4045 => [[['_route' => 'admin_cart_rules_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CartRuleController::deleteAction', '_legacy_controller' => 'AdminCartRules', '_legacy_parameters' => ['id_cart_rule' => 'cartRuleId']], ['cartRuleId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4083 => [[['_route' => 'admin_suppliers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::viewAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:viewsupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['GET' => 0], null, false, false, null]],
        4102 => [[['_route' => 'admin_suppliers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::editAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:updatesupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4123 => [[['_route' => 'admin_suppliers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::deleteAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:deletesupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['DELETE' => 0], null, false, false, null]],
        4152 => [[['_route' => 'admin_suppliers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::toggleStatusAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:statussupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['POST' => 0], null, false, false, null]],
        4182 => [[['_route' => 'admin_manufacturers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::viewAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:viewmanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['GET' => 0], null, false, false, null]],
        4201 => [[['_route' => 'admin_manufacturers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::editAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:updatemanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4222 => [[['_route' => 'admin_manufacturers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::deleteAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:deletemanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4251 => [[['_route' => 'admin_manufacturers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::toggleStatusAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:statusmanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['POST' => 0], null, false, false, null]],
        4283 => [[['_route' => 'admin_manufacturer_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::editAddressAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:editaddresses', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4304 => [[['_route' => 'admin_manufacturer_addresses_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::deleteAddressAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:deleteaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4355 => [
        ...
        4385 => [[['_route' => 'admin_attributes_create', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::createAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId']], ['attributeGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4421 => [[['_route' => 'admin_attributes_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::editAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId', 'attributeId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4462 => [[['_route' => 'admin_attributes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::deleteAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId', 'attributeId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4494 => [[['_route' => 'admin_attributes_bulk_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::bulkDeleteAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId'], ['POST' => 0], null, false, false, null]],
        4536 => [[['_route' => 'admin_attributes_update_position', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::updatePositionAction', '_legacy_controller' => 'AdminAttributesGroups'], ['attributeGroupId'], ['POST' => 0], null, false, false, null]],
        4555 => [[['_route' => 'admin_attribute_groups_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::indexAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['GET' => 0], null, false, false, null]],
        4574 => [[['_route' => 'admin_attribute_groups_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeGroupController::editAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4595 => [[['_route' => 'admin_attribute_groups_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeGroupController::deleteAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4631 => [[['_route' => 'admin_customers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::editAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:updatecustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4650 => [[['_route' => 'admin_customers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::viewAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:viewcustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        ...
        4712 => [[['_route' => 'admin_customers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::toggleStatusAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:statuscustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4760 => [[['_route' => 'admin_customers_transform_guest_to_customer', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::transformGuestToCustomerAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:guesttocustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4807 => [[['_route' => 'admin_customers_toggle_newsletter_subscription', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::toggleNewsletterSubscriptionAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:changeNewsletterVal', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4858 => [[['_route' => 'admin_customers_toggle_partner_offer_subscription', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::togglePartnerOfferSubscriptionAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:changeOptinVal', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4878 => [[['_route' => 'admin_customers_carts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::getCartsAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers'], ['customerId'], ['GET' => 0], null, false, false, null]],
        4899 => [[['_route' => 'admin_customers_orders', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::getOrdersAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers'], ['customerId'], ['GET' => 0], null, false, false, null]],
        4951 => [[['_route' => 'admin_order_messages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\OrderMessageController::editAction', '_legacy_controller' => 'AdminOrderMessage', '_legacy_link' => 'AdminOrderMessage:updateorder_message', 'legacy_parameters' => ['id_order_message' => 'orderMessageId']], ['orderMessageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4972 => [[['_route' => 'admin_order_messages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\OrderMessageController::deleteAction', '_legacy_controller' => 'AdminOrderMessage', '_legacy_link' => 'AdminOrderMessage:deleteorder_message', 'legacy_parameters' => ['id_order_message' => 'orderMessageId']], ['orderMessageId'], ['POST' => 0], null, false, false, null]],
        5013 => [[['_route' => 'admin_customer_threads_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::viewAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['GET' => 0], null, false, false, null]],
        5033 => [[['_route' => 'admin_customer_threads_reply', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::replyAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5071 => [[['_route' => 'admin_customer_threads_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::updateStatusAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId', 'newStatus'], ['POST' => 0], null, false, true, null]],
        5093 => [[['_route' => 'admin_customer_threads_forward', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::forwardAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5132 => [[['_route' => 'admin_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editAction', '_legacy_controller' => 'AdminAddresses', '_legacy_link' => 'AdminAddresses:updateaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5176 => [[['_route' => 'admin_order_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editOrderAddressAction', '_legacy_controller' => 'AdminAddresses'], ['orderId', 'addressType'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5219 => [[['_route' => 'admin_cart_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editCartAddressAction', '_legacy_controller' => 'AdminAddresses'], ['cartId', 'addressType'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5240 => [[['_route' => 'admin_addresses_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::deleteAction', '_legacy_controller' => 'AdminAddresses', '_legacy_link' => 'AdminAddresses:deleteaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        5274 => [[['_route' => 'admin_attachments_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::editAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:updateattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5293 => [[['_route' => 'admin_attachments_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::viewAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:viewattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5314 => [[['_route' => 'admin_attachments_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::deleteAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:deleteattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['POST' => 0], null, false, false, null]],
        5333 => [[['_route' => 'admin_attachments_attachment_info', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::getAttachmentInfoAction'], ['attachmentId'], ['GET' => 0], null, false, false, null]],
        5357 => [[['_route' => 'admin_attachments_search', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::searchAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:search'], ['searchPhrase'], ['GET' => 0], null, false, true, null]],
        5401 => [[['_route' => 'admin_order_invoices_generate_by_id', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\InvoicesController::generatePdfByIdAction', '_legacy_controller' => 'AdminInvoices'], ['invoiceId'], ['GET' => 0], null, false, false, null]],
        5429 => [[['_route' => 'admin_carts_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::viewAction', '_legacy_controller' => 'AdminCarts', '_legacy_link' => 'AdminCarts:viewcart', '_legacy_parameters' => ['id_cart' => 'cartId']], ['cartId'], ['GET' => 0], null, false, false, null]],
        5448 => [[['_route' => 'admin_carts_info', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::getInfoAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['GET' => 0], null, false, false, null]],
        5472 => [[['_route' => 'admin_carts_edit_addresses', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editAddressesAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5494 => [[['_route' => 'admin_carts_edit_carrier', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editCarrierAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5517 => [[['_route' => 'admin_carts_edit_currency', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editCurrencyAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5540 => [[['_route' => 'admin_carts_edit_language', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editLanguageAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5579 => [[['_route' => 'admin_carts_set_delivery_settings', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::updateDeliverySettingsAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5611 => [[['_route' => 'admin_carts_add_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::addCartRuleAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5636 => [[['_route' => 'admin_carts_delete_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::deleteCartRuleAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'cartRuleId'], ['POST' => 0], null, false, false, null]],
        5660 => [[['_route' => 'admin_carts_add_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::addProductAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5695 => [[['_route' => 'admin_carts_edit_product_price', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editProductPriceAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'productId'], ['POST' => 0], null, false, false, null]],
        5733 => [[['_route' => 'admin_carts_edit_product_quantity', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editProductQuantityAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'productId'], ['POST' => 0], null, false, false, null]],
        5763 => [[['_route' => 'admin_carts_delete_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::deleteProductAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5801 => [[['_route' => 'admin_orders_generate_invoice_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateInvoicePdfAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        5845 => [[['_route' => 'admin_orders_generate_delivery_slip_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateDeliverySlipPdfAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        5864 => [[['_route' => 'admin_orders_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::viewAction', '_legacy_controller' => 'AdminOrders', '_legacy_link' => 'AdminOrders:vieworder', '_legacy_parameters' => ['id_order' => 'orderId']], ['orderId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5890 => [[['_route' => 'admin_orders_add_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addCartRuleAction'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5916 => [[['_route' => 'admin_orders_list_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateStatusFromListAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5937 => [[['_route' => 'admin_orders_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateStatusAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5959 => [[['_route' => 'admin_orders_add_payment', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addPaymentAction'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5989 => [[['_route' => 'admin_orders_duplicate_cart', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::duplicateOrderCartAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6019 => [[['_route' => 'admin_orders_change_currency', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::changeCurrencyAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6048 => [[['_route' => 'admin_orders_update_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'orderDetailId'], ['POST' => 0], null, false, true, null]],
        6087 => [[['_route' => 'admin_orders_remove_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::removeCartRuleAction'], ['orderId', 'orderCartRuleId'], ['GET' => 0], null, false, false, null]],
        6144 => [[['_route' => 'admin_orders_resend_email', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::resendEmailAction'], ['orderId', 'orderHistoryId', 'orderStatusId'], ['POST' => 0], null, false, false, null]],
        6166 => [[['_route' => 'admin_orders_preview', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::previewAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6189 => [[['_route' => 'admin_orders_update_shipping', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateShippingAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6222 => [[['_route' => 'admin_orders_update_invoice_note', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateInvoiceNoteAction'], ['orderId', 'orderInvoiceId'], ['POST' => 0], null, false, false, null]],
        6244 => [[['_route' => 'admin_orders_generate_invoice', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateInvoiceAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6275 => [[['_route' => 'admin_orders_send_message', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::sendMessageAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6305 => [[['_route' => 'admin_orders_partial_refund', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::partialRefundAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6336 => [[['_route' => 'admin_orders_standard_refund', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::standardRefundAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6366 => [[['_route' => 'admin_orders_return_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::returnProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6389 => [[['_route' => 'admin_orders_add_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6425 => [[['_route' => 'admin_orders_delete_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::deleteProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'orderDetailId'], ['POST' => 0], null, false, false, null]],
        6449 => [[['_route' => 'admin_orders_get_discounts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getDiscountsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6470 => [[['_route' => 'admin_orders_get_prices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getPricesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6493 => [[['_route' => 'admin_orders_get_payments', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getPaymentsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6516 => [[['_route' => 'admin_orders_get_products', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getProductsListAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6539 => [[['_route' => 'admin_orders_get_invoices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getInvoicesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6563 => [[['_route' => 'admin_orders_get_documents', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getDocumentsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6586 => [[['_route' => 'admin_orders_get_shipping', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getShippingAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6613 => [[['_route' => 'admin_orders_cancellation', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::cancellationAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6662 => [[['_route' => 'admin_orders_display_customization_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::displayCustomizationImageAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'value'], ['GET' => 0], null, false, true, null]],
        6692 => [[['_route' => 'admin_orders_product_prices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getProductPricesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6726 => [[['_route' => 'admin_orders_set_internal_note', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::setInternalNoteAction', '_legacy_controller' => 'AdminOrders', '_legacy_link' => 'AdminOrders:updateInternalNote', '_legacy_parameters' => ['id_order' => 'orderId']], ['orderId'], ['POST' => 0], null, false, false, null]],
        6758 => [[['_route' => 'admin_credit_slips_generate_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CreditSlipController::generatePdfAction', '_legacy_controller' => 'AdminSlip', '_legacy_link' => 'AdminSlip:submitgenerateOrderSlipPdf', '_legacy_parameters' => ['id_order_slip' => 'creditSlipId']], ['creditSlipId'], ['GET' => 0], null, false, false, null]],
        6821 => [[['_route' => 'admin_languages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::editAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:updatelang'], ['languageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        6842 => [[['_route' => 'admin_languages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::deleteAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:deletelang'], ['languageId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        6874 => [[['_route' => 'admin_languages_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::toggleStatusAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:statuslang'], ['languageId'], ['POST' => 0], null, false, false, null]],
        6920 => [[['_route' => 'admin_languages_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::bulkToggleStatusAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:submitBulkupdatelang'], ['status'], ['POST' => 0], null, false, true, null]],
        6957 => [[['_route' => 'admin_currencies_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::editAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:updatecurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        6978 => [[['_route' => 'admin_currencies_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::deleteAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:deletecurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['DELETE' => 0], null, false, false, null]],
        7007 => [[['_route' => 'admin_currencies_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::toggleStatusAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:statuscurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['POST' => 0], null, false, false, null]],
        7040 => [[['_route' => 'admin_currencies_get_reference_data', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::getReferenceDataAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:getReferenceData'], ['currencyIsoCode'], ['GET' => 0], null, false, true, null]],
        7086 => [[['_route' => 'admin_currencies_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::bulkToggleStatusAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:submitBulkupdatecurrency'], ['status'], ['POST' => 0], null, false, true, null]],
        7115 => [[['_route' => 'admin_country_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CountryController::editAction', '_legacy_controller' => 'AdminCountry', '_legacy_parameters' => ['id_country' => 'countryId']], ['countryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7147 => [[['_route' => 'admin_taxes_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::editAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:updatetax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7168 => [[['_route' => 'admin_taxes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::deleteAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:deletetax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['POST' => 0], null, false, false, null]],
        7197 => [[['_route' => 'admin_taxes_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::toggleStatusAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:statustax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['POST' => 0], null, false, false, null]],
        7234 => [[['_route' => 'admin_tax_rules_groups_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::editAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7255 => [[['_route' => 'admin_tax_rules_groups_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::deleteAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['POST' => 0], null, false, false, null]],
        7284 => [[['_route' => 'admin_tax_rules_groups_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::toggleStatusAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['POST' => 0], null, false, false, null]],
        7315 => [[['_route' => 'admin_states_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::editAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7336 => [[['_route' => 'admin_states_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::deleteAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['DELETE' => 0], null, false, false, null]],
        7368 => [[['_route' => 'admin_states_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::toggleStatusAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['POST' => 0], null, false, false, null]],
        7397 => [[['_route' => 'admin_zones_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::editAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:updatezone', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7418 => [[['_route' => 'admin_zones_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::deleteAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:deletezone', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        7447 => [[['_route' => 'admin_zones_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::toggleStatusAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:enableSelection', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['POST' => 0], null, false, false, null]],
        7493 => [[['_route' => 'admin_zones_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::bulkToggleStatus', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:submitBulkupdatezone'], ['status'], ['POST' => 0], null, false, true, null]],
        7549 => [[['_route' => 'admin_module_manage', 'category' => null, 'keyword' => null, '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::manageAction', '_legacy_controller' => 'AdminModulesManage', '_legacy_link' => ['AdminModulesManage', 'AdminModulesSf']], ['category', 'keyword'], ['GET' => 0], null, false, true, null]],
        7656 => [[['_route' => 'admin_module_manage_action', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], ['action', 'module_name'], ['POST' => 0], null, false, true, null]],
        7683 => [[['_route' => 'admin_module_configure_action', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::configureModuleAction', '_legacy_controller' => 'AdminModules'], ['module_name'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        7756 => [[['_route' => 'admin_module_manage_action_bulk', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], ['action'], ['POST' => 0], null, false, true, null]],
        7775 => [[['_route' => 'admin_module_manage_update_all', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], [], ['POST' => 0], null, false, false, null]],
        7830 => [[['_route' => 'admin_themes_enable', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::enableAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:enableTheme', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7863 => [[['_route' => 'admin_themes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::deleteAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:deleteTheme', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7904 => [[['_route' => 'admin_themes_reset_layouts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::resetLayoutsAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:resetToDefaults', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7938 => [[['_route' => 'admin_cms_pages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::editAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:updatecms', '_legacy_parameters' => ['id_cms' => 'cmsPageId']], ['cmsPageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7967 => [[['_route' => 'admin_cms_pages_toggle', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::toggleCmsAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:statuscms', '_legacy_parameters' => ['id_cms' => 'cmsId']], ['cmsId'], ['POST' => 0], null, false, false, null]],
        7988 => [[['_route' => 'admin_cms_pages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::deleteCmsAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:deletecms', '_legacy_parameters' => ['id_cms' => 'cmsId']], ['cmsId'], ['DELETE' => 0], null, false, false, null]],
        8019 => [[['_route' => 'admin_cms_pages_category_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::editCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:updatecms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        8040 => [[['_route' => 'admin_cms_pages_category_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::deleteCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:deletecms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['DELETE' => 0], null, false, false, null]],
        8069 => [[['_route' => 'admin_cms_pages_category_toggle', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::toggleCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:statuscms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['POST' => 0], null, false, false, null]],
        8139 => [[['_route' => 'admin_mail_theme_send_test_mail_deprecated', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'admin_mail_theme_send_test_mail', 'permanent' => true], ['locale', 'theme', 'layout'], null, null, false, true, null]],
        8157 => [[['_route' => 'admin_mail_theme_send_test_module_mail_deprecated', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'admin_mail_theme_send_test_module_mail', 'permanent' => true], ['locale', 'theme', 'module', 'layout'], ['GET' => 0], null, false, true, null]],
        8209 => [[['_route' => 'admin_mail_theme_send_test_mail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::sendTestMailAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme', 'module' => ''], ['locale', 'theme', 'layout'], ['GET' => 0], null, false, true, null]],
        8227 => [[['_route' => 'admin_mail_theme_send_test_module_mail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::sendTestMailAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme'], ['locale', 'theme', 'module', 'layout'], ['GET' => 0], null, false, true, null]],
        8257 => [[['_route' => 'admin_mail_theme_preview', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewThemeAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewTheme'], ['theme'], ['GET' => 0], null, false, true, null]],
        8299 => [[['_route' => 'admin_mail_theme_preview_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewLayout', 'module' => ''], ['locale', 'theme', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8337 => [[['_route' => 'admin_mail_theme_preview_module_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewModuleLayout'], ['locale', 'theme', 'module', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8393 => [[['_route' => 'admin_mail_theme_raw_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::rawLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:rawLayout', 'module' => ''], ['locale', 'theme', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8431 => [[['_route' => 'admin_mail_theme_raw_module_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::rawLayoutAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme'], ['locale', 'theme', 'module', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8474 => [[['_route' => 'admin_carriers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::editAction'], ['carrierId'], ['GET' => 0], null, false, false, null]],
        8495 => [[['_route' => 'admin_carriers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::deleteAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        8524 => [[['_route' => 'admin_carriers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::toggleStatusAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0], null, false, false, null]],
        8555 => [[['_route' => 'admin_carriers_toggle_is_free', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::toggleIsFreeAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0], null, false, false, null]],
        8592 => [[['_route' => 'api_stock_list_product_combinations', '_controller' => 'prestashop.core.api.stock.controller:listProductsAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['GET' => 0], null, false, true, null]],
        8617 => [[['_route' => 'api_stock_edit_product', '_controller' => 'prestashop.core.api.stock.controller:editProductAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['POST' => 0], null, false, true, null]],
        8649 => [[['_route' => 'api_stock_edit_product_combination', '_controller' => 'prestashop.core.api.stock.controller:editProductAction', '_legacy_controller' => 'AdminStockManagement'], ['productId', 'combinationId'], ['POST' => 0], null, false, true, null]],
        8685 => [[['_route' => 'api_stock_product_list_movements', '_controller' => 'prestashop.core.api.stock_movement.controller:listMovementsAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['GET' => 0], null, false, true, null]],
        8705 => [[['_route' => 'api_i18n_translations_list', '_controller' => 'prestashop.core.api.i18n.controller:listTranslationAction'], ['page'], ['GET' => 0], null, false, true, null]],
        8766 => [[['_route' => 'api_translation_domains_tree', '_controller' => 'prestashop.core.api.translation.controller:listTreeAction', '_legacy_controller' => 'AdminTranslations', 'selected' => null], ['lang', 'type', 'selected'], ['GET' => 0], null, false, true, null]],
        8806 => [[['_route' => 'api_translation_domain_catalog', '_controller' => 'prestashop.core.api.translation.controller:listDomainTranslationAction', '_legacy_controller' => 'AdminTranslations', 'theme' => null, 'module' => null], ['locale', 'domain', 'theme'], ['GET' => 0], null, false, true, null]],
        8858 => [
        ...
        8880 => [[['_route' => 'admin_link_block_delete', '_controller' => 'PrestaShop\\Module\\LinkList\\Controller\\Admin\\Improve\\Design\\LinkBlockController::deleteAction', '_legacy_controller' => 'AdminLinkWidget'], ['linkBlockId'], ['POST' => 0], null, false, true, null]],
        8912 => [
