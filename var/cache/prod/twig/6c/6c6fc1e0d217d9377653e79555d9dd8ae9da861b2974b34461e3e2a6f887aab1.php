...
class __TwigTemplate_cce0a5c167dc6ba7b8a227b8391df382dd38df4d33e853857e03580af606f2d8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    >
        ...
        echo "-data\" class=\"typeahead-list nostyle col-sm-12 product-list\">
            ";
        // line 48
        if (((isset($context["collection"]) || array_key_exists("collection", $context)) && (1 === twig_compare(twig_length_filter($this->env, ($context["collection"] ?? null)), 0)))) {
            // line 49
            echo "                ";
...
";
    ...
    public function block_typeahead_product_pack_collection_widget($context, array $blocks = [])
    {
        ...
        echo ((((isset($context["collection"]) || array_key_exists("collection", $context)) && (1 === twig_compare(twig_length_filter($this->env, ($context["collection"] ?? null)), 0)))) ? ("") : ("hide"));
        echo "\">";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/TwigTemplateForm/typeahead.html.twig", "/Users/lucas/Sites/localhost/presta-test/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/typeahead.html.twig");
    }
}
