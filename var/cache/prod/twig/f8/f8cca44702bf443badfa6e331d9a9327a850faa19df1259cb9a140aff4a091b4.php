...
class __TwigTemplate_77ba12e13fec66dfbffc1d83649f642df390c5601e0042292a380162d290948d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_check($__variable__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 30
            echo "  ";
            ((((isset($context["variable"]) || array_key_exists("variable", $context)) && (1 === twig_compare(twig_length_filter($this->env, ($context["variable"] ?? null)), 0)))) ? (print (twig_escape_filter($this->env, ($context["variable"] ?? null), "html", null, true))) : (print (false)));
            echo "
";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/macros.html.twig", "/Users/lucas/Sites/localhost/presta-test/src/PrestaShopBundle/Resources/views/Admin/macros.html.twig");
    }
}
